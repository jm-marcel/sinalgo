...
public class SimpleNode extends Node {
    ...
    @Override
    public void preStep() {
        // Checks if the next node to base station exists and is available to send a message
            ...
            if (message instanceof WsnMsg) {
                ...
                if (wsnMessage.forwardingHop.equals(this)) {
                    ...
                    if (nextNodeToBaseStation == null) {
                        ...
                        // For Example: Node A broadcasts a transmission. Node B receives the message and...
                        // ...broadcasts it back to Node A
                        // Without this feature, the message would be looped back to Node B, generating a loop
                        sequenceNumber = wsnMessage.sequenceID;
                    } else {
                ...
                if (send) {
                    ...
                    // We must change the forwardingHop field (of the message) to store the node wich will be...
                    // ...sending the message
